...
Vue.component('worlduc-addteammember', require('./components/AddTeamMember.vue'));
Vue.component('worlduc-addclassmember', require('./components/AddClassMember.vue'));
Vue.component('worlduc-login', require('./components/WorlducLogin.vue'));
