<template>
  <div class="page" v-if="userInfo.avatar">
    <div class="page-content">
      <div class="user">
        ...
        <div class="userInfo">
          ...
          <div class="bottomInfo">
            <el-popover placement="bottom" trigger="click" @after-leave="reset">
              <div class="popover-edit">
                <el-input v-if="isEdit" v-model="userInfo.phone" placeholder="请输入内容" size="mini"></el-input>
                <div v-else>
                ...
                <el-button
                  ...
                  type="text"
                  size="mini"
                  @click="sureChange('tel')"
                >&nbsp;&nbsp;&nbsp;确定</el-button>
                <el-button
                  v-else-if="userInfo.phone"
                  type="text"
                  size="mini"
                  @click="edit"
                >&nbsp;&nbsp;&nbsp;重新绑定</el-button>
                <el-button v-else type="text" size="mini" @click="edit">绑定</el-button>
              </div>
              <svg
                class="iconIn"
            ...
            <el-popover placement="bottom" trigger="click" @after-leave="reset">
              <div class="popover-edit">
                <el-input v-if="isEdit" v-model="userInfo.QQ" placeholder="请输入内容" size="mini"></el-input>
                <div v-else>
      ...
      <div class="detail" v-if="role == 4">
        <el-tabs v-model="activeName" stretch @tab-click="handleClick">
          <el-tab-pane name="mytask">
            <span slot="label">
              <svg class="iconIn icon-active" slot="reference" aria-hidden="true">
                <use xlink:href="#icon-task" />
              </svg>
              &nbsp;我的课题
            </span>
            <el-table :data="taskData" style="width: 100%">
              <el-table-column prop="title" label="课题" min-width="180px"></el-table-column>
              ...
              >
                <template slot-scope="scope">
                  <el-tag
                    :type="scope.row.time === '已过期' ? 'info' : 'success'"
                    disable-transitions
                  >{{scope.row.time === '已过期' ? '' : '剩'}}{{scope.row.time}}</el-tag>
                </template>
              </el-table-column>
              <el-table-column
                prop="isSubmit"
              ...
              >
                <template slot-scope="scope">
                  <el-tag
                    :type="scope.row.isSubmit === true ? 'success' : 'info'"
                    plain
                  >{{scope.row.isSubmit === true ? '已提交' : '未提交'}}</el-tag>
                </template>
              </el-table-column>
              <el-table-column prop="isLeader" label="操作" width="140px">
                <template slot-scope="scope">
                  <div style="display:flex">
                    <el-button size="mini" type="primary" @click="toTask(scope.row.taskId)">查看</el-button>
                    <el-button
                      v-if="scope.row.isLeader"
                      size="mini"
                      type="danger"
                      @click="leaveTask(scope.row.taskId, scope.row.teamId, scope.$index)"
                    >退出</el-button>
                  </div>
                </template>
              </el-table-column>
          ...
          <el-tab-pane name="myresult">
            ...
            <el-table :data="resData" style="width: 100%">
              <el-table-column prop="title" label="成果" min-width="100px"></el-table-column>
              <el-table-column prop="task" label="课题" min-width="180px"></el-table-column>
              <el-table-column prop="team" label="团队" sortable></el-table-column>
              <el-table-column prop="created_at" label="提交时间" sortable width="170px"></el-table-column>
              <el-table-column prop="action" label="操作" width="75px">
                <template slot-scope="scope">
                  <el-button size="mini" type="primary" @click="toResult(scope.row.id)">查看</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-tab-pane>
          <el-tab-pane name="myansrec">
            ...
            <el-table :data="surveyRecordList" style="width: 100%">
              <el-table-column prop="course" label="课程" sortable></el-table-column>
              <el-table-column prop="score" label="得分" min-width="50px"></el-table-column>
              <el-table-column prop="updated_at" label="填写时间" sortable width="170px"></el-table-column>
                ...
                <template slot-scope="scope">
                  <div style="display:flex">
                    <el-button
                      size="mini"
                      type="primary"
                      @click="toCustomCourse(scope.row.course_id)"
                    >查看</el-button>
                    <el-button
                      size="mini"
                      type="danger"
                      @click="deleteSurRec(scope.row.id, scope.$index)"
                    >删除</el-button>
                  </div>
                </template>
              </el-table-column>
          ...
          <el-tab-pane name="myteam">
            ...
            <el-table :data="teamData" style="width: 100%">
              ...
              <el-table-column prop="team" label="队名" min-width="50px"></el-table-column>
              <el-table-column prop="leader" label="队长" width="80px"></el-table-column>
              <el-table-column prop="memberNum" label="成员数" width="75px"></el-table-column>
              <el-table-column prop="desc" label="队简介" min-width="140px"></el-table-column>
              <el-table-column
                prop="action"
                label="操作"
                width="75px"
              ...
              >
                <template slot-scope="scope">
                  <el-button
                    ...
                    size="mini"
                    type="danger"
                    @click="dissolveTeam(scope.row.id, scope.$index)"
                  >解散</el-button>
                  <el-button
                    v-else
                    size="mini"
                    type="danger"
                    @click="leaveTeam(scope.row.id, scope.$index)"
                  >退出</el-button>
                </template>
              </el-table-column>
            </el-table>
